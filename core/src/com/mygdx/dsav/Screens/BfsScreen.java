...
import com.mygdx.dsav.Generators.GBfsAlg;
...
public class BfsScreen extends FactOption {
    ...
    @Override
    public void create() {
        generator = new GBfsAlg(TREESIZE);
        algActive = false;
        typingSelector = -1;
        hintTextString = "";
        ...
        orderText.add("Order:");
        orderText.add("------");
        titleButtonBox = new BenHelper.Rect(GW*0.26f, GH*0.85f, GW*0.48f, GH*0.15f);
    ...
    public String updateBefore(String factSelector) {
        ...
        if (titleButtonBox.checkHover()) {
            hintTextString = "Breadth First Search is a Graph Searching Algorithm. Visit all \n"+
                ...
                "BFS is implemented using a Queue. O(N) Time, O(N) Space.";
        }
